            ...
            <table class="table border-0">
                ...
                <tbody class="table-group-divider invoice-body">
                    <tr>
                        ...
                        <td><input type="number" class="form-control fw-bold text-end qty" min="0" step="any" placeholder="Quantity"></td>
                        <td><input type="number" class="form-control fw-bold text-end rate" min="0" step="any" placeholder="Rate"></td>
